  ...
  <header id="header" class="fixed-top">
      <div class="container d-flex align-items-center">
        <a href="index.php" class="logo me-auto"
          ><img src="assets/img/logo-sehat.png" alt=""
        /></a>
    ...
    <a href="logout.php" class="appointment-btn scrollto"
        ...
        <div class="row no-gutters">
          ...
          <div class="col-lg-3 col-md-6 d-md-flex align-items-md-stretch">
            <div class="count-box">
              ...
              <span data-purecounter-start="0" data-purecounter-end="<?php echo $row['kode_informasi']; ?>" data-purecounter-duration="1" class="purecounter"></span>
